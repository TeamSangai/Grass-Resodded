...
public class SeaGrassStoneBlock extends SpreadableBlock implements Fertilizable {
    public static final MapCodec<SeaGrassStoneBlock> CODEC = createCodec(SeaGrassStoneBlock::new);

    public static final BooleanProperty SNOWY = Properties.SNOWY;

    public SeaGrassStoneBlock(Settings settings) {
        super(settings);
    }
