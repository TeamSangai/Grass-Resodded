...
public class GrassMudBlock extends SpreadableBlock implements Fertilizable {
    public static final MapCodec<GrassMudBlock> CODEC = createCodec(GrassMudBlock::new);
    private static final VoxelShape COLLISION_SHAPE = Block.createCuboidShape( 0.0, 0.0, 0.0, 16.0, 14.0, 16.0);
    public static final BooleanProperty SNOWY = Properties.SNOWY;
    public MapCodec<GrassMudBlock> getCodec() {
        return CODEC;
    }

    public GrassMudBlock(Settings settings) {
        super(settings);
