...
public class DryGrassyStoneBlock extends SpreadableBlock implements Fertilizable {
    public static final MapCodec<DryGrassyStoneBlock> CODEC = createCodec(DryGrassyStoneBlock::new);


    protected DryGrassyStoneBlock(Settings settings) {
        super(settings);
    }
