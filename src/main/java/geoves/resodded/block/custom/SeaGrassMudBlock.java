...
public class SeaGrassMudBlock extends SpreadableBlock implements Fertilizable {
    public static final MapCodec<SeaGrassMudBlock> CODEC = createCodec(SeaGrassMudBlock::new);
    private static final VoxelShape COLLISION_SHAPE = Block.createCuboidShape( 0.0, 0.0, 0.0, 16.0, 14.0, 16.0);
    public static final BooleanProperty SNOWY = Properties.SNOWY;
    public MapCodec<SeaGrassMudBlock> getCodec() {
        return CODEC;
    }

    public SeaGrassMudBlock(Settings settings) {
        super(settings);
