...
public class GrassyStoneBlock extends SpreadableBlock implements Fertilizable {
    public static final MapCodec<GrassyStoneBlock> CODEC = createCodec(GrassyStoneBlock::new);

    public static final BooleanProperty SNOWY = Properties.SNOWY;

    public GrassyStoneBlock(Settings settings) {
        super(settings);
    }
