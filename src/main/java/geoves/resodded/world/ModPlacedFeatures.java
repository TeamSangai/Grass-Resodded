...
public static final RegistryKey<PlacedFeature> LAVENDER_PATCH_PLACED_KEY = registerKey("lavender_patch_placed");
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        register(context, LAVENDER_PATCH_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.LAVENDER_PATCH),
    ...
    public static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(GrassResodded.MOD_ID, name));
    }
